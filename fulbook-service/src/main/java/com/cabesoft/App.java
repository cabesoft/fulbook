...
public class App {
	public static void main(String[] args) {
		...
		// PhysicalStatDaoImpl physicalStatDaoImpl = (PhysicalStatDaoImpl)
		// appContext
		...
		//
		// SocialStatAmount socialStatAmount = new SocialStatAmount(socialStat,
		// 5);
		// Set<SocialStatAmount> socialItemStats = new
		// HashSet<SocialStatAmount>();

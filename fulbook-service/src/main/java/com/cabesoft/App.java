...
//    			
//    			//persisto el item
//    			PhysicalItemDaoImpl physicalItemDaoImpl= (PhysicalItemDaoImpl)appContext.getBean("physicalItemDaoImpl");
...
//    			Set<PhysicalItemEquiped>  physicalItems= new HashSet<PhysicalItemEquiped>();
//    			
//    			PhysicalItemEquiped physicalItemEquiped= new PhysicalItemEquiped();
//    			physicalItemEquiped.setEquiped(true);
//    			
//    			physicalItems.add(physicalItemEquiped);
//    			physicalItemEquiped.setItem(physicalItem);
